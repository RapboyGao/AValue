        ...
        let patterns: [(pattern: String, parse: (NSTextCheckingResult) throws -> ALatitude)] = [
            ...
            (
                ...
                parse: { result in
                    ...
                    guard let degrees = Int(degreesString),
                          let minutes = Double(minutesString) else {
                        throw ALatitudeError.errorWhenParsingNumber
                    }
            ...
            (
                ...
                parse: { result in
                    ...
                    guard let degrees = Int(degreesString),
                          ...
                          let seconds = Double(secondsString) else {
                        throw ALatitudeError.errorWhenParsingNumber
                    }
            ...
            (
                ...
                parse: { result in
                    ...
                    guard let degrees = Int(degreesString),
                          let minutes = Double(minutesIntString) else {
                        throw ALatitudeError.errorWhenParsingNumber
                    }
            ...
            (
                ...
                parse: { result in
                    ...
                    guard let degrees = Int(degreesString),
                          let minutes = Double("\(minutesIntString).\(minuteDigitString)") else {
                        throw ALatitudeError.errorWhenParsingNumber
                    }
            ...
            (
                ...
                parse: { result in
                    ...
                    guard let degrees = Int(degreesString),
                          let minutes = Int(minutesString),
                          let seconds = Double(secondsIntString) else {
                        throw ALatitudeError.errorWhenParsingNumber
                    }
