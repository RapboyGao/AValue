...
import AViewUI
    ...
    public struct AWindLimitEditFSContent: View {
            ...
            HStack {
                ...
                if allowSet {
                    AMathFormatTextfield(
                        number: bindRunwayHeading,
                        precision: .integerAndFractionLength(
                            integerLimits: 3...3,
                            fractionLimits: 0...1
                        ),
                        placeholder: I18n.rwyHDG,
                        rightAligned: true
                    )
                    .multilineTextAlignment(.trailing)
                    .keyboardType(.decimalPad)
                } else if let runwayHeading = windLimitValue?
                    .runwayHeadingInDegrees
                {
                    Spacer()
        ...
        public init(
            _ windLimitValue: Binding<AWindLimit?>,
            unit: Binding<AUnit?>,
            originalUnit: AUnit?,
            allowSet: Bool,
